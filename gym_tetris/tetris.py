...
class Tetris(object):
    ...
    def reset(self) -> None:
        ...
        self.frame = 1
        self.last_move_down_time = self.frame - 1
        self.last_move_side_time = self.frame - 1
        self.last_rotate_time = self.frame - 1
        self.last_fall_time = self.frame - 1
        self.is_game_over = False

    def steps(self, actions) -> None:
        for ac in actions:
